    ...
    public function run(): void
    {
        ...
        $permissionsByModule = [
            ...
            'Facturación' => [
                ...
                'invoices.stamp' => 'Timbrar facturas ante el SAT',
                ...
                'invoices.settings.manage_logo' => 'Subir y eliminar logotipos de emisores fiscales',
                'invoices.settings.delete_fiscal_profiles' => 'Eliminar emisores fiscales',
