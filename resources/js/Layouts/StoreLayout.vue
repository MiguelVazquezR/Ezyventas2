    ...
    <div :style="rootStyles" class="min-h-screen bg-gray-50 flex flex-col">
        ...
        <header class="bg-white border-b border-gray-200 sticky top-0 z-40">
            <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg font-semibold m-0" style="color: var(--store-primary)">{{ store.name || 'Tienda' }}</h1>
        ...
        <footer class="bg-white border-t border-gray-200 mt-auto">
            <div class="max-w-6xl mx-auto px-4 py-6 text-center">
                ...
                <p v-else class="text-xs text-gray-400 m-0">{{ store.name || 'Tienda' }} &mdash; Desarrollado por EzyVentas</p>
            </div>
        </footer>
    </div>
</template>
