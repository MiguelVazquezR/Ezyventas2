...
const form = useForm({
    ...
    image: null,
    sat_product_code: props.service.sat_product_code || '',
    sat_unit_code: props.service.sat_unit_code || '',
        ...
        <form @submit.prevent="submit" class="mt-6 max-w-3xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <template v-if="hasBilling">
                    <div>
                        <InputLabel for="sat_product_code" value="Clave de Servicio (En caso de emitir factura)" />
                    ...
                    <div>
                        <InputLabel for="sat_unit_code" value="Clave Unidad (En caso de emitir factura)" />
