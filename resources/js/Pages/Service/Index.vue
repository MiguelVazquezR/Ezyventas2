            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 md:p-6">
                ...
                <div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <SplitButton label="Nuevo Servicio" icon="pi pi-plus" @click="router.get(route('services.create'))" :model="splitButtonItems" severity="warning"></SplitButton>
                    </div>
                </div>
                ...
                <DataTable :value="services.data" v-model:selection="selectedServices" lazy paginator
                    :totalRecords="services.total" :rows="services.per_page"
                    ...
                    <Column field="show_online" header="Visible en Tienda" sortable>
                         <template #body="{ data }">
                            <i class="pi" :class="{ 'pi-check-circle text-green-500': data.show_online, 'pi-times-circle text-red-500': !data.show_online }"></i>
                        </template>
                    </Column>
