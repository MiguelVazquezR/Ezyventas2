    ...
    <StoreLayout>
        <div class="max-w-2xl mx-auto px-4 py-12">
            <div class="bg-white rounded-2xl border border-gray-200 p-8 text-center">
                ...
                <h1 class="text-2xl font-bold text-gray-900 m-0 mb-2">Order confirmed</h1>
                <p class="text-gray-500 mb-6">Thank you for your order! Here is your order number:</p>

                <div class="bg-gray-50 rounded-2xl p-6 mb-8 inline-block">
                    <p class="text-[10px] uppercase tracking-widest font-bold text-gray-500 m-0 mb-1">Order number</p>
                ...
                <div class="text-left bg-gray-50 rounded-2xl p-6 mb-8 space-y-2">
                    <h2 class="text-sm font-semibold text-gray-700 m-0 mb-3">Order summary</h2>
                ...
                <p class="text-sm text-gray-500 mb-6">
                    {{ order.delivery_type === 'pickup' ? 'You can pick up your order at the store.' : 'Your order will be delivered to the provided address.' }}
                </p>

                <a :href="route('store.home', { slug: new URL(window.location.href).pathname.split('/')[2] })">
                    <Button label="Continue shopping" icon="pi pi-arrow-left" severity="secondary" outlined class="!rounded-full" />
                </a>
            </div>
        </div>
    </StoreLayout>
