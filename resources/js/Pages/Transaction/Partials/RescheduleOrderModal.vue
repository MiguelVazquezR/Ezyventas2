...
const submit = () => {
    ...
    router.put(route('transactions.reschedule-order', props.transactionId), {
        new_delivery_date: toLocalISOString(newDate.value)
    }, {
        onSuccess: () => {
...
<template>
    <Dialog v-model:visible="isVisible" modal header="Reprogramar entrega" :style="{ width: '25rem' }">
        <div class="flex flex-col gap-4 py-2">
            ...
            <div class="flex flex-col gap-2">
                ...
                <DatePicker v-model="newDate" showTime hourFormat="12" dateFormat="dd/mm/yy" :minDate="new Date()" showIcon class="w-full" />
            </div>
        </div>
        <template #footer>
