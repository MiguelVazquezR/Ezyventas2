    ...
    <AppLayout title="Nueva factura">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-2 mb-6">
            ...
            <div class="flex gap-2 w-full sm:w-auto">
                <Button label="Cancelar" severity="secondary" text class="!rounded-full !uppercase !tracking-widest !text-xs !font-bold !justify-center w-full sm:w-auto" @click="$inertia.visit(route('billing.invoices.index'))" />
            </div>
        </div>
