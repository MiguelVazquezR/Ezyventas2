...
<template>
    ...
    <SectionCard id="forma-pago" icon="pi pi-credit-card" title="Forma y método de pago" subtitle="Condiciones de la factura">
        ...
        <Message v-if="form.payment_method === 'PPD'" severity="info" variant="simple" size="small">
            Con método PPD la forma de pago suele ser "99 - Por definir" hasta que se reciba el pago; después
            se genera un CFDI de Pago relacionado. Puedes cambiar estos valores libremente.
        </Message>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
