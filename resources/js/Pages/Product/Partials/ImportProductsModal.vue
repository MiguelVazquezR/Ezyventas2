...
<template>
     <Dialog :visible="visible" @update:visible="closeModal" modal header="Importar Productos desde Excel" :style="{ width: '35rem' }">
        <form @submit.prevent="submit" class="p-2">
            <div class="text-sm text-gray-600 dark:text-gray-400 space-y-2 mb-4">
                <p>Sube un archivo .xlsx o .xls con las siguientes columnas para importar tus productos:</p>
                <code class="bg-gray-100 dark:bg-gray-700 p-2 rounded-md block text-xs">
                    nombre, sku, descripcion, precio_de_venta, precio_de_compra, stock_actual, stock_minimo, stock_maximo, categoria, marca
                </code>
