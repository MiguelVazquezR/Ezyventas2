...
const deleteExpense = () => {
    confirm.require({
        message: `¿Estás seguro de que quieres eliminar el gasto con folio "${props.expense.folio}"?`,
...
<template>
    ...
    <Head :title="`Gasto: ${expense.folio}`" />
    <AppLayout>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-4 mb-6">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400 mt-1">Folio: {{ expense.folio }}</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                        ...
                        <div>
                            ...
                            <ul class="space-y-3 text-sm">
                                <li class="flex justify-between"><span class="text-gray-500">Estatus</span>
                                    <Tag :value="expense.status" :severity="getStatusSeverity(expense.status)" />
                                </li>
                    ...
                    <div v-if="expense.description" class="mt-6 pt-4 border-t">
