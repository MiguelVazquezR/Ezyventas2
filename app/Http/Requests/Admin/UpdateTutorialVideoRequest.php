...
class UpdateTutorialVideoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'file'        => [
                'nullable',
                // A new file is only required when switching to "file" without
                // an already uploaded one (otherwise it is kept or replaced).
                Rule::requiredIf(fn () => $this->input('source_type') === 'file' && ! $tutorial?->file_path),
                'file',
