...
{
    /**
     * Only users with invoicing settings access can create fiscal profiles.
     */
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => [
                'required', 'email', 'max:255', 'unique:fiscal_profiles,email',
            ],
        ];
    }
    ...
    /**
     * Normalize RFC to uppercase and trim whitespace.
     */
